...
For local development, create a `.env` file in the `src` directory with the following configuration:

```
APP_NAME=Laravel
APP_ENV=local
APP_KEY=base64:bBiE9BuiB1eXQ6xHPXmPqExhk8afTsqjfoozSrEZvhA=
APP_DEBUG=true
...
# Use MySQL for local development (matches docker-compose)
DB_CONNECTION=mysql
DB_HOST=db
DB_PORT=3306
